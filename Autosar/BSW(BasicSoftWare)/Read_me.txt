Basic SoftWare layer that layer whitch run on Microconroller.
it divided to Four layer:
1-(MCAL)Microconroller Abstraction layer. (internal HW,internal peripherals)
